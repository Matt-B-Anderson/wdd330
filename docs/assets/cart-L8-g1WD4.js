import { g as o } from "./utils-D6dTBaom.js";
/* empty css              */ function n() {
  const a = o("so-cart"),
    t = a.map((r) => l(r));
  document.querySelector(".product-list").innerHTML = t.join("");
  const c = a.reduce((r, e) => r + e.FinalPrice, 0);
  a.length > 0 && (document.querySelector(".total").innerHTML = `Total: $${c}`);
}
function l(a) {
